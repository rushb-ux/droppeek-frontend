  ...
  return (
    <Box maxW="800px" mx="auto" py={10} px={4}>
      ...
      <VStack spacing={6} align="start">
        ...
        <Text>
          <strong>7. Contact:</strong> For privacy-related questions, please reach out via our official X account: <a href="https://x.com/aaron_key5303" target="_blank" rel="noopener noreferrer">@aaron_key5303</a>
        </Text>
      </VStack>
    </Box>
  );
